      ...
      <div className="tabla-personalizada">
        ...
        {!modoPanel && (
          <>
            ...
            {/* Placeholder inicial sin búsqueda */}
            ...
            {/* Tabla de productos una vez se ha buscado */}
            {haBuscado && (
              <div className="productos-page__table-wrapper">
                <DataTable
                   ...
                   * - ordenar columnas
                   * - aplicar filtros de columna (embudos)
                   * y vuelve a llamar al backend con los nuevos parámetros.
                   */
                ...
                {/* Capa de carga sobre la tabla cuando se está refrescando */}
                {estaCargando && (
        ...
        {/* Panel lateral de edición / detalle de producto */}
