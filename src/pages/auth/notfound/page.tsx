...
// Adapted NotFound page for this project structure (React Router style)
export default function NotFoundPage() {
  const navigate = useNavigate();
  const { user } = useAuth();

  // Nota: Para simplicidad renderizamos un botón que navega según el estado de auth
  const handleGoBack = () => {
    // Si el contexto aún no tiene user pero hay token en localStorage,
    // consideramos al usuario autenticado y vamos al dashboard.
    ...
    <>
      ...
      <div className="px-5 min-h-screen flex justify-content-center align-items-center">
        <div className="z-1 text-center">
          <div className="text-900 font-bold text-8xl mb-4">Oopaas!</div>
          <p className="line-height-3 mt-0 mb-5 text-700 text-xl font-medium">No hay nada aqui</p>
          <button
            type="button"
